...
export default function ProfilePicture({ navigation }) {
  ...
  return (
    <View style={{ alignItems: "center", alignContent: "center", alignSelf: "center" }}>
      <ImageBackground source={require('../../../assets/videos/1.gif')} resizeMethod={'auto'} resizeMode={'stretch'} style={{ borderWidth: 1, height: '100%', borderColor: "#000", width: width, position: "absolute" }}>
