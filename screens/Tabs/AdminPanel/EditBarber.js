    ...
    <>
        ...
        <ListItem containerStyle={{ backgroundColor: "#181818", width:width }}>
          <ListItem.Content style={{ flex: 1, flexDirection: 'row' }}>
            <ListItem.Title style={{ color: "#fff" ,width:width*(12/14)}}>Berber Settings</ListItem.Title>
      ...
      >
        <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
          ...
          >
          <View style={{flexDirection:"column",justifyContent:"center",alignContent:"center",alignItems:"center",alignSelf:"center",height:"20%"}}>
        ...
        <View style={{flexDirection:"row",width:width-50}}>
          <Text style={{ color: '#668', fontSize: 13,width:width*(10/14)}}>Remove Barber : {(selectedItem2)}</Text>
