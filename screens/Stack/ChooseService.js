...
import {View,Text,Dimensions,StyleSheet,ScrollView,RefreshControl,TouchableOpacity,SafeAreaView,Platform,Image} from 'react-native';
  ...
  function Item(props) {
    ...
    return (
        <View style={{flexDirection:"row",padding:7,width:screenWidth}}>
          ...
          style={{backgroundColor:"#181818",marginLeft:10,width:80,height:80,justifyContent:"center",alignSelf:"flex-end",marginRight:30}}
        >
    ...
    <SafeAreaView style={{flex:1,backgroundColor:'#181818'}}>
      <View style={{width: width, height: height,backgroundColor: "#141414"}}>
        <View style={{flexDirection:'row',backgroundColor:"#181818",height:50,alignItems:'center',justifyContent:'space-between'}}>
          <Text style={{color:'white',fontWeight:'700',textAlign:'center',width:width,fontSize:17,alignContent:"center"}}>Select Service</Text>
        </View>
        <View style={styles.container}>
    <Text style={styles.barberbutton2}>Choose Category</Text>
  <View style={styles.filterBar}>
    <TouchableOpacity style={styles.button} title="Man" onPress={onClick(1)}>
    <Image style={styles.tinyLogo}source={require('../../assets/categories/man.png')}/>
      <Text style={styles.barberbutton2}>Man</Text>
    </TouchableOpacity>
    <TouchableOpacity style={styles.button} title="Child" onPress={onClick(2)}>
    <Image style={styles.tinyLogo}source={require('../../assets/categories/kids.png')}/>
